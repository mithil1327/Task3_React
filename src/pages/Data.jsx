            ...
            <form onSubmit={handleTable}>
                <div>
                    <input 
                        ...
                        value={sub1} 
                        onChange={(e) => handleInputChange(setSub1, e.target.value)} 
                        min="0" 
                        max="100" 
                    />
                    <br />
                    <input 
                        ...
                        value={sub2} 
                        onChange={(e) => handleInputChange(setSub2, e.target.value)} 
                        min="0" 
                        max="100" 
                    />
                    <br />
                    <input 
                        ...
                        value={sub3} 
                        onChange={(e) => handleInputChange(setSub3, e.target.value)} 
                        min="0" 
                        max="100" 
                    />
                    <br />
                    <input 
                        ...
                        value={sub4} 
                        onChange={(e) => handleInputChange(setSub4, e.target.value)} 
                        min="0" 
                        max="100" 
                    />
                    <br />
                    <input 
                        ...
                        value={sub5} 
                        onChange={(e) => handleInputChange(setSub5, e.target.value)} 
                        min="0" 
                        max="100" 
                    />
                    <br />
